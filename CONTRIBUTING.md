# Welcome to AquaRelay Contributing Guide

Thank you for your interest in contributing to **AquaRelay** 🎨  
...
If you are new to the project, start by reading the [README](README.md) to understand AquaRelay's goals and architecture.
...
3. Run the server locally to verify your changes: You can use: ```php src/AquaRelay.php```
...
🎉 Congratulations and thank you for contributing to **AquaRelay**!

Once merged:

* Your contribution becomes part of the project
* Your GitHub profile will reflect your contribution
* You are officially part of the AquaRelay community
